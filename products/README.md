...
(`shop/shop-copy.md`: title, announcement, About, policies, buyer message, FAQ), and ready-to-upload
visuals in `shop/assets/` (logo, shop icon, Etsy cover banner, Gumroad cover, Everything-Bundle hero).
Regenerate/rebrand with `python3 build_brand.py`.
